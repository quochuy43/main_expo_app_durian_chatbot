...
export default function ChatbotScreen() {
    ...
    // Xử lý ảnh từ Camera page
    const [hasProcessedImage, setHasProcessedImage] = useState(false);

    useEffect(() => {
        if (params.imageUri && params.imageName && params.imageType && !hasProcessedImage) {
            // Set pending image từ params
            chat.setInitialImage({
                uri: params.imageUri,
                file: {
                    uri: params.imageUri,
    ...
    }, [params.imageUri, params.imageName, params.imageType, hasProcessedImage]);
...
const styles = StyleSheet.create({
    flex1: { flex: 1 },
    header: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingVertical: 16, paddingHorizontal: 20, borderBottomWidth: 1, borderBottomColor: "#E5E5E5" },
